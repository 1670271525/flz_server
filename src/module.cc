...
static flz::ConfigVar<std::string>::ptr g_module_path
...
bool Module::onConnect(flz::Stream::ptr stream) {
    return true;
}

bool Module::onDisconnect(flz::Stream::ptr stream) {
    return true;
}
...
void ModuleManager::init() {
    ...
    flz::FSUtil::ListAllFile(files, path, ".so");
