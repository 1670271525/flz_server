...
namespace flz {
	...
	public:
		 ...
		 * @param[in] address 地址
		 */
		static Socket::ptr CreateTCP(flz::Address::ptr address);

		/**
		 * @brief 创建UDP Socket(满足地址类型)
		 * @param[in] address 地址
		 */
		static Socket::ptr CreateUDP(flz::Address::ptr address);
	...
	public:
		...
		static SSLSocket::ptr CreateTCP(flz::Address::ptr address);
