...
public:
    ...
    virtual bool onConnect(flz::Stream::ptr stream);
    virtual bool onDisconnect(flz::Stream::ptr stream);
...
typedef flz::Singleton<ModuleManager> ModuleMgr;
