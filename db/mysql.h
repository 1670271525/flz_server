#pragma once
#ifndef __FLZ_DB_MYSQL_H__
#define __FLZ_DB_MYSQL_H__
...
public:
    ...
    flz::IStmt::ptr prepare(const std::string& sql) override;
...
typedef flz::Singleton<MySQLManager> MySQLMgr;
