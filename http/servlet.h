#pragma once
#ifndef __FLZ_SERVLET_H__
#define __FLZ_SERVLET_H__
...
public:
    ...
    virtual int32_t handle(flz::http::HttpRequest::ptr request
                   ...
                   , flz::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (flz::http::HttpRequest::ptr request
                   , flz::http::HttpResponse::ptr response
                   , flz::http::HttpSession::ptr session)> callback;
