...
int32_t FunctionServlet::handle(flz::http::HttpRequest::ptr request
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("flz/1.0"));
}

int32_t ServletDispatch::handle(flz::http::HttpRequest::ptr request
               , flz::http::HttpResponse::ptr response
               , flz::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(flz::http::HttpRequest::ptr request
                   , flz::http::HttpResponse::ptr response
                   , flz::http::HttpSession::ptr session) {
    response->setStatus(flz::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "flz/1.0.0");
