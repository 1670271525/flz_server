...
int32_t FunctionWSServlet::onConnect(flz::http::HttpRequest::ptr header
...
int32_t FunctionWSServlet::onClose(flz::http::HttpRequest::ptr header
                                     ,flz::http::WSSession::ptr session) {
    if(m_onClose) {
...
int32_t FunctionWSServlet::handle(flz::http::HttpRequest::ptr header
