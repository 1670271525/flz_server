...
public:
    ...
    virtual int32_t onConnect(flz::http::HttpRequest::ptr header
                              ,flz::http::WSSession::ptr session) = 0;
...
public:
    ...
    typedef std::function<int32_t (flz::http::HttpRequest::ptr header
                              ,flz::http::WSSession::ptr session)> on_connect_cb;
    typedef std::function<int32_t (flz::http::HttpRequest::ptr header
                             ,flz::http::WSSession::ptr session)> on_close_cb; 
    typedef std::function<int32_t (flz::http::HttpRequest::ptr header
                           ,flz::http::WSFrameMessage::ptr msg
                           ,flz::http::WSSession::ptr session)> callback;
