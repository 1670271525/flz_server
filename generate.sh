...
command_error_exit git clone https://github.com/1670271525/flz_server.git
command_error_exit cp flz_server/Makefile .
command_error_exit cp -rf flz_server/template/* .
command_error_exit cp -rf flz_server/template/* .
